...
assert.match(borrowLanQrCard, /aria-label="Save LAN settings"/)
assert.match(borrowLanQrCard, /title="Save LAN settings"/)
assert.match(borrowLanQrCard, /aria-label="Detect LAN IP"/)
assert.match(borrowLanQrCard, /title="Detect LAN IP"/)
...
assert.match(settingsView, /settingsSubCardClass/)
assert.match(settingsView, /bg-\[var\(--surface-hover\)\]/)
assert.match(settingsView, /bg-\[var\(--bg\)\]/)
